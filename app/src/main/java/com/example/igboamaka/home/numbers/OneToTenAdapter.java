...
public class OneToTenAdapter extends RecyclerView.Adapter<OneToTenAdapter.ViewHolder> {
    ...
    public OneToTenAdapter(Context context, List<Numbers> numbers, RecyclerViewClickListener listener) {
        mContext = context;
        this.numbers = numbers;
        OneToTenAdapter.listener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.numbers_one_to_ten_item_view, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            englishDigit = itemView.findViewById(R.id.one_to_ten_digit);
            igboTranslation = itemView.findViewById(R.id.one_to_ten_igbo);
            cardView = itemView.findViewById(R.id.card_view_number_one_to_ten);
