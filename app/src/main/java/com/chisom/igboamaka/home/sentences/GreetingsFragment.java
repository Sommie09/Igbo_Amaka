...
public class GreetingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        GreetingsAdapter.RecyclerViewClickListener listener = new GreetingsAdapter.RecyclerViewClickListener() {
            @Override
        ...
        GreetingsAdapter adapter = new GreetingsAdapter(getContext(), sentences, listener);
